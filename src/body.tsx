...
return(
        <div> 
            <div className="grid lg:grid-cols-2 gap-8 pl-4 pr-4 pt-8 md:pl-20 md:pr-20 md:pt-28 lg:pt-32 bg-gray-50">
            ...
            sm:grid-cols-1 gap-7  pl-4 pr-4 xl:p-16 md:pl-30 md:pr-30 bg-gray-50 ">
